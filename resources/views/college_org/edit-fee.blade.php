...
<div class="bg-white rounded shadow p-6 max-w-2xl">
    ...
    <form method="POST" action="{{ route('college_org.fees.update', $fee->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end gap-2">
            <a href="{{ route('college_org.fees') }}" class="px-4 py-2 border rounded">Cancel</a>
