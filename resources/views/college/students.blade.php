...
<div class="flex justify-between items-center mb-6">
    ...
    <!-- Add Student Button triggers modal -->
    <button onclick="document.getElementById('addStudentModal').classList.remove('hidden')" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
        + Add Student
    </button>

    <a href="{{ route('college.academics') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
