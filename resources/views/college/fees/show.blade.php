        ...
        <div>
            ...
            <div class="mt-2">
                @if($fee->accreditation_file)
                    <a href="{{ \Illuminate\Support\Facades\Storage::url($fee->accreditation_file) }}" target="_blank" class="text-blue-600 hover:underline">Download Certificate of Accreditation</a>
                @else
                ...
                @if($fee->resolution_file)
                    <div class="mt-2">
                        <a href="{{ \Illuminate\Support\Facades\Storage::url($fee->resolution_file) }}" target="_blank" class="text-blue-600 hover:underline">Download Resolution of Collection</a>
                    </div>
                @endif
            </div>
        </div>
