        ...
        <div class="space-y-3">
            <div class="flex items-center justify-between gap-3">
                <div>
                    ...
                    <p class="text-sm text-slate-500">Welcome, {{ auth()->user()->full_name }}</p>
                </div>
            </div>
            ...
            <div class="relative">
                <input
                    ...
                    class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm shadow-sm outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                    autocomplete="off"
                >
                <ul id="searchResults"
        ...
        <div id="regularFeesPanel" class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div class="mt-4 space-y-4">
                <div class="space-y-2 text-sm">
                    ...
                    <div class="mt-3">
                        ...
                        <input
                            type="number"
                            id="regularCashInput"
                            class="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            min="0"
                            step="0.01"
                        >
                    </div>
                ...
                <button id="regularProceedPayment"
                    class="w-full rounded-xl bg-blue-700 py-3 text-sm font-semibold text-white transition hover:bg-blue-800 disabled:cursor-not-allowed disabled:bg-slate-300"
                >
                    Proceed Payment
                </button>
            </div>
...
searchInput.addEventListener('input', function () {
    ...
    fetch(`/treasurer/cashiering/search?q=${encodeURIComponent(query)}`)
        .then(res => {
...
function loadStudentDetails(studentId) {
    fetch(`/treasurer/cashiering/student/${studentId}`)
        .then(res => {
...
regularProceedBtn.addEventListener('click', () => {
    ...
    fetch('/treasurer/cashiering/collect', {
        method:'POST',
