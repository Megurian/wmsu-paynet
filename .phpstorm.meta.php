...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.promissory_note_reminder_days_before_due' => 'integer',
            'auth.defaults.guard' => 'string',
            'auth.defaults.passwords' => 'string',
            'auth.guards.web.driver' => 'string',
            'auth.guards.web.provider' => 'string',
            'auth.guards.student.driver' => 'string',
            'auth.guards.student.provider' => 'string',
            ...
            'filesystems.links.C:\Users\DELL\Herd\wmsu-paynet\public\storage' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.promissory_note_reminder_days_before_due','auth.defaults.guard','auth.defaults.passwords',
'auth.guards.web.driver','auth.guards.web.provider','auth.guards.student.driver','auth.guards.student.provider','auth.providers.users.driver',
'auth.providers.users.model','auth.providers.students.driver','auth.providers.students.model','auth.passwords.users.provider','auth.passwords.users.table',
'auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.students.provider','auth.passwords.students.table','auth.passwords.students.expire',
'auth.passwords.students.throttle','auth.password_timeout','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'database.redis.cache.backoff_algorithm','database.redis.cache.backoff_base','database.redis.cache.backoff_cap','excel.exports.chunk_size','excel.exports.pre_calculate_formulas',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\DELL\\Herd\\wmsu-paynet\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'signed','throttle','verified','role','student',
'guest.student',);
        registerArgumentsSet('routes', 'osa.setup',
'osa.setup.create-academic-setup','osa.setup.store','osa.setup.addSemester','osa.setup.start-semester','osa.setup.end-semester',
'osa.setup.toggle-auto','osa.system-maintenance','osa.system-maintenance.email-settings','osa.system-maintenance.execute-command','osa.dashboard',
'osa.fees','osa.fees.create','osa.fees.store','osa.fees.show','osa.fees.approve',
'osa.fees.disable','osa.appeals.accept','osa.appeals.reject','osa.organizations','osa.organizations.create',
'osa.organizations.store','osa.organizations.resendInvite','osa.organizations.show','osa.organizations.destroy','osa.organizations.toggle-osa-inheritance',
'osa.college','osa.college.create','osa.college.store','osa.college.resendInvite','osa.college.checkCode',
'osa.college.checkEmail','osa.organizations.checkCode','osa.organizations.checkEmail','osa.college.details','osa.college.destroy',
'osa.reports','osa.reports.college.details','osa.reports.organization.details','osa.remittance','osa.remittance.confirm',
'osa.fees.enable','osa.fee-requests.approve','osa.fee-requests.reject','university_org.dashboard','university_org.offices',
'university_org.reports','university_org.remittance','university_org.remittance.confirm','university_org.fees','university_org.fees.create',
'university_org.fees.store','university_org.fees.show','university_org.fees.edit','university_org.fees.update','university_org.fees.destroy',
'university_org.fees.appeal','university_org.offices.index','university_org.offices.create','university_org.offices.store','university_org.offices.resendInvite',
'university_org.organizations.checkCode','university_org.organizations.checkEmail','university_org.documents.index','university_org.documents.store','university_org.documents.preview',
'university_org.documents.destroy','university_org.child_org_fees','university_org.reports.generate','college_org.dashboard','college_org.fees',
'college_org.fees.create','college_org.fees.store','college_org.fees.show','college_org.fees.edit','college_org.fees.update',
'college_org.fees.destroy','college_org.fees.appeal','college_org.payment','college_org.records','college_org.search_students',
'college_org.generate_report','college_org.students.fees',
'college_org.documents.index','college_org.documents.store','college_org.documents.preview','college_org.documents.destroy','college_org.organization_management',
'college_org.info.updateLogo','college_org.info.updateName','college.students.my-upload','college.students.my-upload.store','college.students.readd',
'college.students.readd.bulk','college.fees.approval','college.fees.show','college.fees.approve','college.fees.reject','college.dashboard','college.students','college.history',
'college.academics','college.courses.store','college.years.store','college.sections.store','college.courses.destroy',
'college.years.destroy','college.sections.destroy','college.students.store','college.students.destroy','college.students.show',
'college.students.update','college.students.unvalidate','college.users.assign-course','college.users.index','college.users.create',
'college.users.store','college.users.destroy','college.info.updateLogo','college.info.updateName','college.students.import.template',
'college.students.import','college.students.import.preview','college.local_organizations.approvals','college.local_organizations.approve','college.local_organizations.reject',
'college.students.clear-for-enrollment','college.students.promissory_notes.store','college.students.history','college.history.report',
'college.students.update-field','college.students.promotion.preview','college.students.promotion.execute','college.students.promote.pay','college.students.bulk.promote-pay',
'employees.store','employees.update','employees.destroy','employees.resendInvite',
'college.roles.bulkAssign','employees.toggle','college.roles.history','employees.template','employees.import',
'employees.preview','college.local_organizations.assign','college.local_organizations.officers.resendInvite','college.logs','college.students.validate',
'college.students.validate.store','college.students.validate.bulk','college.promissory_notes.index','college.promissory_notes.dashboard',
'college.promissory_notes.export','college.promissory_notes.document','college.promissory_notes.approve','college.promissory_notes.reject','adviser.promissory_notes.index',
'adviser.promissory_notes.document','adviser.promissory_notes.approve','adviser.promissory_notes.reject','treasurer.cashiering','college.students.markPaid','college.fees',
'college.fees.create','college.fees.store','college.local_organizations','college.local_organizations.create','college.local_organizations.store',
'college.local_organizations.checkCode','college.local_organizations.checkEmail','college.local_organizations.show','college.local_organizations.cancel_submission','profile.edit',
'profile.update','profile.destroy','register','login','login.choice','login.choice.post','password.request','password.email',
'password.reset','password.store','verification.notice','verification.verify','verification.send',
'password.confirm','password.update','logout','student.login',
'student.','student.password.request','student.password.email','student.password.reset','student.password.store',
'student.logout','student.dashboard','student.payments','student.payments.receipt','student.promissory_notes.index',
'student.promissory_notes.download','student.promissory_notes.sign','student.profile','student.profile.update','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.portal-choice','auth.register',
'auth.reset-password','auth.verify-email','college.academics','college.cashiering','college.create-user',
'college.dashboard','college.employees','college.enrollments','college.fees.approval','college.fees.create',
'college.fees.index','college.fees.show','college.history','college.local_organizations.approvals','college.local_organizations.college_org',
'college.local_organizations.create','college.local_organizations.show','college.logs','college.payments','college.promissory_notes_approval',
'college.promissory_notes_dashboard','college.reports.history-pdf','college.roles.history','college.student-details','college.student-history-info',
'college.students','college.students.my-upload','college.users','college.validate_students','college.verify-payment-content',
'college_org.create-fee','college_org.dashboard','college_org.edit-fee','college_org.fee-details','college_org.fees',
'college_org.organization_management.index','college_org.organization_management.info','college_org.organization_management.officers','college_org.payment','college_org.records',
'college_org.reports.payment_report_pdf','components.application-logo','components.auth-session-status','components.danger-button','components.dropdown',
'components.dropdown-link','components.input-error','components.input-label','components.modal','components.nav-link',
'components.preview-modal','components.primary-button','components.responsive-nav-link','components.secondary-button','components.sidebar-link',
'components.text-input','documents.index','layouts.app','layouts.auth','layouts.dashboard',
'layouts.guest','layouts.landing','layouts.navigation','osa.college','osa.college-details',
'osa.create-academic-setup','osa.create-college','osa.create-fee','osa.create-organization','osa.dashboard',
'osa.fee-details','osa.fees','osa.organization-details','osa.organizations','osa.remittance',
'osa.reports','osa.reports.college-details','osa.reports.organization-details','osa.setup','osa.system-maintenance',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','resources.views.college_org.organization_management.index.blade.php',
'student.dashboard','student.layouts.student-dashboard','student.payments.index','student.payments.receipt_pdf','student.profile',
'student.promissory_notes','student.promissory_notes_template_pdf','university_org.child_org_fees','university_org.create-fees','university_org.create-offices',
'university_org.dashboard','university_org.edit-fee','university_org.fee-details','university_org.fees','university_org.offices',
'university_org.offices-detail','university_org.remittance','university_org.reports','university_org.reports_pdf','university_org.sample-report',
...
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Users.DELL.Herd.wmsu-paynet.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
